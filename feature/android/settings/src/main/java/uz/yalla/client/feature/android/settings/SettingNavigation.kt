...
import uz.yalla.client.feature.android.settings.settings.navigation.SETTINGS_ROUTE
import uz.yalla.client.feature.core.navigation.safeNavigate
import uz.yalla.client.feature.android.settings.settings.navigation.settingsScreen
...
fun NavController.navigateToSettingsModule() = safeNavigate(SETTING_MODULE_ROUTE)