...
class MapService(
    ...
    suspend fun getSecondaryAddressed(
        ...
        safeApiCall {
            ktorWithApi2.post(MapUrl.SECONDARY_ADDRESSES) { setBody(body) }
        }
}
